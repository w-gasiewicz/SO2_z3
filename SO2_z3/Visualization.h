...
public:
    Visualization();
    void Start(Client clients[],Distributor distributors[],SalesMan salesmans[], vector<int> & gasolineQueue,vector<int> & paymentQueue, vector<int> & washQueue, CarWash & carwash);
